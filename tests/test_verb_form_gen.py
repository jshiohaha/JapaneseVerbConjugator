...
from src.japverbconj.constants.enumerated_types import Formality
...
class TestPositiveVerbForms(unittest.TestCase):
    ...
    def test_conditional_plain(self, _, verb):
        ...
        result = jvfg.generate_conditional_form(verb.Verb, verb.Verb_Class,
                                                Formality.PLAIN, self.polarity)
    ...
    def test_volitional_plain_positive(self, _, verb):
        result = jvfg.generate_volitional_form(verb.Verb, verb.Verb_Class,
                                               Formality.PLAIN, self.polarity)
    ...
    def test_imperative_plain_positive(self, _, verb):
        result = jvfg.generate_imperative_form(verb.Verb, verb.Verb_Class,
                                               Formality.PLAIN, self.polarity)
    ...
    def test_provisional_plain_positive(self, _, verb):
        result = jvfg.generate_provisional_form(verb.Verb, verb.Verb_Class,
                                                Formality.PLAIN, self.polarity)
    ...
    def test_causative_plain_positive(self, _, verb):
        result = jvfg.generate_causative_form(verb.Verb, verb.Verb_Class,
                                              Formality.PLAIN, self.polarity)
    ...
    def test_passive_plain_positive(self, _, verb):
        result = jvfg.generate_passive_form(verb.Verb, verb.Verb_Class,
                                            Formality.PLAIN, self.polarity)
