...
class TestPositiveVerbForms(ParametrizedTestCase):
    ...
    def test_polite_positive_nonpast(self):
        result = self.japaneseVerbFormGenerator.generate_polite_form(
            self.verb.Verb, self.verb.Verb_Class, Tense.NONPAST, self.polarity
        )
        self.assertEqual(result, self.verb.PolitePositiveNonpast)

    def test_polite_positive_past(self):
        result = self.japaneseVerbFormGenerator.generate_polite_form(
            self.verb.Verb, self.verb.Verb_Class, Tense.PAST, self.polarity
        )
    ...
    def test_te_form(self):
        result = self.japaneseVerbFormGenerator.generate_te_form(
            self.verb.Verb, self.verb.Verb_Class
        )
    ...
    def test_conditional_plain(self):
        ...
        result = self.japaneseVerbFormGenerator.generate_conditional_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
    ...
    def test_conditional_polite(self):
        if self.verb.Verb_Class == VerbClass.IRREGULAR:
            self.skipTest("Not Required for Irregular Verbs")
        result = self.japaneseVerbFormGenerator.generate_conditional_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.POLITE, self.polarity
        )
    ...
    def test_volitional_plain_positive(self):
        # if self.verb.Verb_Class == VerbClass.IRREGULAR:
        #     self.skipTest("Not Required for Irregular Verbs")
        result = self.japaneseVerbFormGenerator.generate_volitional_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
    ...
    def test_potential_plain_positive(self):
        result = self.japaneseVerbFormGenerator.generate_potential_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
    ...
    def test_imperative_plain_positive(self):
        result = self.japaneseVerbFormGenerator.generate_imperative_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
    ...
    def test_provisional_plain_positive(self):
        result = self.japaneseVerbFormGenerator.generate_provisional_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
    ...
    def test_causative_plain_positive(self):
        result = self.japaneseVerbFormGenerator.generate_causative_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
    ...
    def test_passive_plain_positive(self):
        result = self.japaneseVerbFormGenerator.generate_passive_form(
            self.verb.Verb, self.verb.Verb_Class, Formality.PLAIN, self.polarity
        )
...
def create_positive_verb_form_suite(suite):
    ...
    """
    suite.addTest(
        ParametrizedTestCase.parametrize(TestPositiveVerbForms, param=GodanVerbNomu)
    )
    suite.addTest(
        ParametrizedTestCase.parametrize(TestPositiveVerbForms, param=IchidanVerbTaberu)
    )
    suite.addTest(
        ParametrizedTestCase.parametrize(TestPositiveVerbForms, param=IrregularVerbSuru)
    )
    suite.addTest(
        ParametrizedTestCase.parametrize(TestPositiveVerbForms, param=IrregularVerbKuru)
    )
...
def create_negative_verb_form_suite(suite):
    ...
    """
    suite.addTest(
        ParametrizedTestCase.parametrize(TestNegativeVerbForms, param=GodanVerbNomu)
    )
    suite.addTest(
        ParametrizedTestCase.parametrize(TestNegativeVerbForms, param=IchidanVerbTaberu)
    )
    suite.addTest(
        ParametrizedTestCase.parametrize(TestNegativeVerbForms, param=IrregularVerbSuru)
    )
    suite.addTest(
        ParametrizedTestCase.parametrize(TestNegativeVerbForms, param=IrregularVerbKuru)
    )
